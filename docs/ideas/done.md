# Done
Scrap page for human. Agents should not use this or read this. Reading or using this will degrade AI performance by clogging up context

# list of done things

* things human reviewed then checked
...
* DONE review W4 and W5
    ...
    * W4 and W5 have a hand off plan
        ...
        * wait 
* DONE test the W4 railway deploy
    * DONE asked for fixes,
    ...
    * ADDED DISCLAIMER AND TO BACKLOG how is that value derived from the source linked: Annual production per kW (Maine)
        * in rooftop and plug in solar. Kind of getting it but not sure why it's written like that
        1200 kWh/kW/yr
        default (sourced)
        What this means
...
* DONE when done with the plan, backlog and next ideas / future iterations
